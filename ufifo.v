...
//
module ufifo(i_clk, i_rst, i_wr, i_data, o_empty_n, o_full, i_rd, o_data, o_status, o_err, i_dmp_clk, i_dmp_pos, o_dmp_data, o_dmp_valid);
   ...
   input  wire                i_dmp_clk; // clk we use to dump
